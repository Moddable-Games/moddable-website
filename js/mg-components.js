/* =========================================================================
   Moddable.Games — Components: Navbar, Footer, ModCard, PageHero, Buttons
   Depends on: mg-core.js (window._MG_CORE)
   ========================================================================= */

window._MG_COMPONENTS = (() => {
  const { T, F, CATEGORY_COLORS, HEX_BG, el, css, url, cubeSVG } = window._MG_CORE;
  ...
  return { btn, linkBtn, modCard, pageHero };
})();
