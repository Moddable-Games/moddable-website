...
export const HEX_BG = `url("${url('/img/hex-grid-blue.svg')}")`;
export const HEX_BG_RED = `url("${url('/img/hex-grid-red.svg')}")`;
export const HEX_BG_GREEN = `url("${url('/img/hex-grid-green.svg')}")`;
...
export function css(obj) { return obj; }

export function cubeSVG(size = 32) {
