import { el, linkBtn, navbar, footer, sectionHero, T } from './mg.js';
...
ctaBtns.appendChild(linkBtn('Tools API', '/developers/api/', 'blue'));
var serverBtn = linkBtn('Live Server', 'https://tools.moddable.games/', 'outline-dark');
