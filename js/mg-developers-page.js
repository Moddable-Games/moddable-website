import { el, linkBtn, navbar, footer, sectionHero, buildHeroFeature, T, url } from './mg.js';
...
document.getElementById('page-hero').appendChild(sectionHero({
  ...
  lede: '56 callable tools across seven namespaces. Connect from any MCP client, call via REST, or build bots for Telegram, Slack, and Discord.',
...
var destinations = [
  {
    title: 'Tools API',
    body: '56 tools for chess, hex maps, piece gallery, rules queries, RPG oracles (10 systems), entity browser, encounter building, classic game engines, and utilities. Connect in one command via MCP or call via REST.',
...
ctaBtns.appendChild(linkBtn('Connect Now', '/developers/api/', 'blue'));
ctaBtns.appendChild(linkBtn('View Live Server', 'https://tools.moddable.games/', 'outline-dark'));
