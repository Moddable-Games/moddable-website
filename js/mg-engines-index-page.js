import { el, url, data, navbar, footer, sectionHero, buildHeroFeature, initReveal, T, linkBtn } from './mg.js';
...
document.getElementById('page-hero').appendChild(sectionHero({
  ...
  feature: buildHeroFeature('engines')
}));
...
data.get('engines').then(function(engines) {
