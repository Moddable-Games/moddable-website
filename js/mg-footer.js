(function() {
  ...
  function footer() {
    const COLS = [
      ...
      { title:'Tools',     href:url('/tools/'),     links:[['TI4 tools',url('/tools/ti/')],['Talisman tools',url('/tools/talisman/')],['Nukes tools',url('/tools/nukes/')],['Combat odds',url('/tools/combat/')],['Deck builder',url('/tools/decks/')],['Chess variants',url('/tools/chess/')],['Hex maps',url('/engines/moddable-hexmaps/')]] },
