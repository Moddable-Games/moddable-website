(function() {
  ...
  function footer() {
    const COLS = [
      ...
      { title:'Developers', href:url('/developers/'), links:[['Tools API',url('/developers/')],['MCP Server','https://tools.moddable.games/'],['llms.txt','https://tools.moddable.games/llms.txt'],['GitHub','https://github.com/Moddable-Games']] },
