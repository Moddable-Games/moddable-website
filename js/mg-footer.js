(function() {
  ...
  function footer() {
    const COLS = [
      ...
      { title:'Games',     href:url('/games/'),     links:[['Endless Skies',url('/games/endless-skies/')],['Mongo',url('/games/planet-mongo/')],['Nukes',url('/games/nukes/')]] },
    ...
    brand.appendChild(el('p', { class:'mg-footer__tagline' }, 'Creating games you already own. Ten mods. Three games. Two engines. One Discord.'));
