import { el, url, data, navbar, footer, sectionHero, buildHeroFeature, initReveal, linkBtn } from './mg.js';
...
document.getElementById('page-hero').appendChild(sectionHero({
  ...
  feature: buildHeroFeature('games')
}));
...
data.load(['games']).then(function(store) {
