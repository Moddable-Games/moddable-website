...
const FLOAT_ICONS = {
  ...
  submit: [{ svg: docIcon, count: 2 }, { svg: penIcon, count: 2 }],
  community: [{ svg: sparkIcon, count: 2 }, { svg: hexIcon, count: 2 }],
  team: [{ svg: sparkIcon, count: 2 }, { svg: hexIcon, count: 2 }],
  press: [{ svg: docIcon, count: 2 }, { svg: sparkIcon, count: 2 }],
  roadmap: [{ svg: sparkIcon, count: 2 }, { svg: hexIcon, count: 2 }],
  'tool-ti': [{ svg: hexIcon, count: 2 }, { svg: sparkIcon, count: 2 }],
  'tool-talisman': [{ svg: hexIcon, count: 2 }, { svg: sparkIcon, count: 2 }],
  'tool-nukes': [{ svg: hexIcon, count: 2 }, { svg: sparkIcon, count: 2 }],
  'tool-dice': [{ svg: diceIcon, count: 2 }, { svg: sparkIcon, count: 2 }],
  'tool-decks': [{ svg: cardIcon, count: 2 }, { svg: sparkIcon, count: 2 }],
  'tool-chess': [{ svg: pawnIcon, count: 2 }, { svg: sparkIcon, count: 2 }]
};
...
export function buildHeroFeature(section) {
  if (section === 'mods') {
