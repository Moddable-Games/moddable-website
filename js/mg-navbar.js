(function() {
  ...
  function navbar(activeId) {
    const NAV_ITEMS = [
      ...
      { id:'Tools', href:url('/tools/'), children:[['TI tools',url('/tools/ti/')],['Talisman tools',url('/tools/talisman/')],['Nukes tools',url('/tools/nukes/')],['Combat odds',url('/tools/combat/')],['Deck builder',url('/tools/decks/')],['Chess variants',url('/tools/chess/')]] },
