(function() {
  ...
  function navbar(activeId) {
    const NAV_ITEMS = [
      ...
      { id:'Games', href:url('/games/'), children:[['Nukes',url('/games/nukes/')],['Mongo',url('/games/mongo/')],['Endless Skies',url('/games/endless-skies/')],['Dungeon Chess',url('/games/dungeon-chess/')]] },
      ...
      { id:'Tools', href:url('/tools/'), children:[['TI tools',url('/tools/ti/')],['Talisman tools',url('/tools/talisman/')],['Nukes tools',url('/tools/nukes/')],['Combat odds',url('/tools/combat/')],['Deck builder',url('/tools/decks/')],['Chess variants',url('/tools/chess/')],['Hex maps',url('/engines/moddable-hexmaps/')]] },
