...
var visionItems = [
  { num: '01', label: 'ENGINE', title: 'Host any hex-based game online.', body: 'A universal runtime for hex-grid games with drag pieces, resolved rules, and live spectating.', color: MG.T.green },
  { num: '02', label: 'MARKETPLACE', title: 'Designers sell mods and expansions.', body: 'Upload your creation, set a price or go free, and reach thousands of players instantly.', color: MG.T.blue },
  { num: '03', label: 'COMMUNITY', title: 'Players find groups and run tournaments.', body: 'Matchmaking, leaderboards, and event scheduling built into the platform.', color: MG.T.red },
];
