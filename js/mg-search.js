...
(function() {
  ...
  const SEARCH_INDEX = [
    ...
    {type:'mod', title:'Flooded Catan', desc:'Survival variant — the island sinks beneath you', href:url('/mods/flooded-catan/')},
    {type:'mod', title:'The Diamond Mine', desc:'Single-hex Catan expansion with diamond resources', href:url('/mods/the-diamond-mine/')},
    {type:'mod', title:'Shattered Ascension', desc:'Community overhaul of TI3 with rebalanced factions', href:url('/mods/shattered-ascension/')},
