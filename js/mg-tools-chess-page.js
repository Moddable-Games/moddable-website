...
function renderMatch() {
  ...
  sel.addEventListener('change', function() {
    ...
    renderPicker();
    renderRules();
    if (track) track('chess_variant_select', { variant: VARIANTS[currentIdx].name, source: 'dropdown' });
  });
  ...
  form.appendChild(btn('Start Match', 'blue', function() {
    ...
    if (track) track('chess_match_start', { variant: v.name, mode: mode });
...
if (engineBtns) {
const playBtn = linkBtn('Moddable Chess', '/engines/moddable-chess/', 'primary');
