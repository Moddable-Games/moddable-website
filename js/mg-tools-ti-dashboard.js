...
function buildSetupStep1() {
  ...
  if (ti4Data && ti4Data.expansions && ti4Data.expansions.length) {
    ...
    ti4Data.expansions.forEach(function(exp) {
      ...
      b.addEventListener('click', function() { setup.enabledExpansions[exp.key] = !setup.enabledExpansions[exp.key]; render(); });
...
function renderAgendaTab() {
  ...
  const clearBtn = el('button', { className: 'td-outline-btn', textContent: 'Discard' });
